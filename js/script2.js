...
input.addEventListener('keyup', (e) => {
	...
	if(!text) {
		...
		const suggestionItems = `
			...
			<li class="suggestion">${highLightMatch('耳号22036',text)}</li>
			<li class="suggestion">${highLightMatch('耳号26268',text)}</li>
			<li class="suggestion">${highLightMatch('耳号20398',text)}</li>
		`;
